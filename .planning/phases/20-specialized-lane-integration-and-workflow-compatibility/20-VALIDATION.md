...
| **Quick run command** | `cd materials-discovery && uv run pytest tests/test_llm_evaluate_schema.py tests/test_llm_evaluate_cli.py tests/test_llm_compare_core.py tests/test_llm_compare_cli.py tests/test_llm_campaign_lineage.py tests/test_report.py tests/test_real_mode_pipeline.py -x -v` |
...
- **After Wave 2 specialized-lane proof and compare/report work:** Run `cd materials-discovery && uv run pytest tests/test_llm_evaluate_cli.py tests/test_llm_compare_core.py tests/test_llm_compare_cli.py tests/test_llm_campaign_lineage.py tests/test_report.py -x -v`
- **After Wave 3 second-system compatibility proof and docs wiring:** Run `cd materials-discovery && uv run pytest tests/test_real_mode_pipeline.py tests/test_cli.py -x -v`
...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 20-01-01 | 01 | 1 | LLM-15, OPS-09 | schema/unit | `cd materials-discovery && uv run pytest tests/test_llm_evaluate_schema.py -x -v` | ✅ | ⬜ pending |
| 20-01-02 | 01 | 1 | LLM-15, OPS-09 | evaluation/core | `cd materials-discovery && uv run pytest tests/test_llm_evaluate_schema.py -x -v` | ✅ | ⬜ pending |
| 20-02-01 | 02 | 2 | LLM-15 | CLI/integration | `cd materials-discovery && uv run pytest tests/test_llm_evaluate_cli.py -x -v` | ✅ | ⬜ pending |
| 20-02-02 | 02 | 2 | LLM-16, OPS-09 | compare/report/integration | `cd materials-discovery && uv run pytest tests/test_llm_compare_core.py tests/test_llm_compare_cli.py tests/test_llm_campaign_lineage.py tests/test_report.py -x -v` | ✅ | ⬜ pending |
| 20-03-01 | 03 | 3 | LLM-16, OPS-09 | real-mode/integration | `cd materials-discovery && uv run pytest tests/test_real_mode_pipeline.py -x -v` | ✅ | ⬜ pending |
| 20-03-02 | 03 | 3 | LLM-16 | docs/CLI regression | `cd materials-discovery && uv run pytest tests/test_cli.py tests/test_llm_compare_cli.py -x -v` | ✅ | ⬜ pending |
...
- [ ] Wave 0 covers all new Phase 20 seams
