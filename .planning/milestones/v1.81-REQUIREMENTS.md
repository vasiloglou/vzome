# Requirements Archive: v1.81 Extensive LLM Tutorial and Programmatic vZome Visualization MVP
...
Tracked after the milestone archive so the shipped notebook setup work is still
visible in the `v1.81` record without pretending it was part of the original
phase planning pass.

- [x] **OPS-27**: Operator can create a plain Python 3.11 virtual environment
  from committed `materials-discovery/requirements.txt` and execute
  `materials-discovery/notebooks/guided_design_tutorial.ipynb` successfully
  without relying on the repo's existing `uv`-managed environment.
...
| OPS-27 | Phase 43 addendum | Complete |

**Coverage:**
- v1.81 requirements: 7 total
- Mapped to phases: 7
- Unmapped: 0

---
*Requirements defined: 2026-04-15*
*Last updated: 2026-04-15 after notebook-venv addendum tracking*
